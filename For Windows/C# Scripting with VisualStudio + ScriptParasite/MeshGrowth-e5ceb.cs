...
/// </summary>
public abstract class Script_Instance_e5ceb : GH_ScriptInstance
{
  ...
  /// </summary>
  #region Runscript
  private void RunScript(bool iReset, Mesh iStartingMesh, bool iGrow, int iSubiterationCount, int iMaxVertexCount, double iCollisionDistance, double iCollisionWeight, double iEdgeLengthWeight, double iBendingResistanceWeight, bool iUseRTree, ref object oMesh)
  {

    // for debuggin
    Print(iMaxVertexCount.ToString());
    Print(iCollisionDistance.ToString());
    Print(iCollisionWeight.ToString());
    ...
    if (iReset || meshGrowthSys == null)
    {
      ...
      //  return;
      //}
      meshGrowthSys = new MeshGrowthSystem(iStartingMesh, Print, iGrow, iMaxVertexCount, iCollisionDistance, iCollisionWeight, iEdgeLengthWeight, iBendingResistanceWeight, iUseRTree);
  ...
  public class MeshGrowthSystem
  {
    ...
    public MeshGrowthSystem(Mesh inputMesh, Action<string> printMethod, bool grow, int maxVertexCount, double collisionDistance, double collisionWeight, double edgeLengthWeight, double bendingResistanceWeight, bool useRTree)
    {
      ptMesh = inputMesh.ToPlanktonMesh();
      _print = printMethod;
      ...
      EdgeLengthConstraintWeight = edgeLengthWeight;
      BendingResistanceWeight = bendingResistanceWeight;
      UseRTree = useRTree;
    }
